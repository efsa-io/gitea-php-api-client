 ...
 */
class CreatePullReviewComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePullReviewComment';
     ...
     * Sets path
     *
     * @param string|null $path the tree path
     *
     * @return self
     */
