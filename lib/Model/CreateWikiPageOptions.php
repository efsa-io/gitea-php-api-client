 ...
 */
class CreateWikiPageOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWikiPageOptions';
     ...
     * Sets title
     *
     * @param string|null $title page title. leave empty to keep unchanged
     *
     * @return self
     */
